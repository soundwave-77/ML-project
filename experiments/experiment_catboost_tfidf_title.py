...
def preprocess_data(df_train, train_emb):
    ...
    dense_df_title.columns = [f'embedding_{i}' for i in range(dense_df_title.shape[1])]

    df_train = pd.concat([df_train.reset_index(drop=True), dense_df_title], axis=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='catboost_tfidf_title', help='Name of the ClearML task')
    ...
    title_emb = joblib.load(title_emb_path)
